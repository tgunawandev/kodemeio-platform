"""Doctor diagnostic checks for kctl-glitchtip."""
...
class APIConnectivityCheck:
    ...
    def run(self) -> CheckResult:
        try:
            from kctl_glitchtip.core.config import get_service_config, resolve_active_profile_name
            ...
            if not url:
                return CheckResult(
                    ...
                    fix_command="kctl-glitchtip config init",
                )
