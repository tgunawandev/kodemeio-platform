...
def generate(
    ...
    from kctl_rmm.cli import app as cli_app

    skill_name = "rmm-admin"
    description = "Tactical RMM remote monitoring via kctl-rmm CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-rmm skill generate")
            raise typer.Exit(1)
