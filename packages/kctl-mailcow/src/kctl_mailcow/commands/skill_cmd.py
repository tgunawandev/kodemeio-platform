...
def generate(
    ...
    from kctl_mailcow.cli import app as cli_app

    skill_name = "mailcow-admin"
    description = "Mailcow mail server administration via kctl-mailcow CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-mailcow skill generate")
            raise typer.Exit(1)
