"""Doctor diagnostic checks for kctl-mailcow."""
...
class APIConnectivityCheck:
    ...
    def run(self) -> CheckResult:
        try:
            from kctl_mailcow.core.config import get_service_config, resolve_active_profile_name
            ...
            if not url:
                return CheckResult(
                    ...
                    fix_command="kctl-mailcow config init",
                )
