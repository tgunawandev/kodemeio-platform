"""Doctor diagnostic checks for kctl-telegram."""
...
class ConfigCheck:
    ...
    def run(self) -> CheckResult:
        try:
            from kctl_telegram.core.config import get_service_config, resolve_active_profile_name
            ...
            if not cfg.api_key:
                return CheckResult(
                    ...
                    fix_command="kctl-telegram config init",
                )
