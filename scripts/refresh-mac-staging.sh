...
#
# Refs: docs/superpowers/plans/2026-04-10-mac-staging-clone.md Task 10
...
kctl-dokploy compose redeploy --name "${DOKPLOY_ERP_APP}"

log "Redeploying Dokploy compose ${DOKPLOY_HRMS_APP}"
kctl-dokploy compose redeploy --name "${DOKPLOY_HRMS_APP}"
