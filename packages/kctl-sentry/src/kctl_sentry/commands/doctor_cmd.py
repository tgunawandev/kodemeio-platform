"""Doctor diagnostic checks for kctl-sentry."""
...
class ConfigCheck:
    ...
    def run(self) -> CheckResult:
        try:
            from kctl_sentry.core.config import get_service_config, resolve_active_profile_name
            ...
            if not cfg.auth_token:
                return CheckResult(
                    ...
                    fix_command="kctl-sentry config init",
                )
