...
def generate(
    ...
    from kctl_sentry.cli import app as cli_app

    skill_name = "sentry-admin"
    description = "Sentry error tracking administration via kctl-sentry CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-sentry skill generate")
            raise typer.Exit(1)
