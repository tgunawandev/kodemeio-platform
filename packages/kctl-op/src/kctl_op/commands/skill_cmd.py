...
def generate(
    ...
    from kctl_op.cli import app as cli_app

    skill_name = "1password-admin"
    description = "1Password secret management via kctl-op CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-op skill generate")
            raise typer.Exit(1)
