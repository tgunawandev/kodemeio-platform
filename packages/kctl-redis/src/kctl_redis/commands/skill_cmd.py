...
def generate(
    ...
    from kctl_redis.cli import app as cli_app

    skill_name = "redis-admin"
    description = "Redis server administration via kctl-redis CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-redis skill generate")
            raise typer.Exit(1)
