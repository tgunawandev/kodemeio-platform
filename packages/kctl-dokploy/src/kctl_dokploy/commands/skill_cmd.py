...
def generate(
    ...
    from kctl_dokploy.cli import app as cli_app

    skill_name = "dokploy-admin"
    description = "Dokploy deployment platform administration via kctl-dokploy CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-dokploy skill generate")
            raise typer.Exit(1)
