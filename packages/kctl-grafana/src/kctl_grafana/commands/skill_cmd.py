...
def generate(
    ...
    from kctl_grafana.cli import app as cli_app

    skill_name = "grafana-admin"
    description = "Grafana monitoring platform administration via kctl-grafana CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-grafana skill generate")
            raise typer.Exit(1)
