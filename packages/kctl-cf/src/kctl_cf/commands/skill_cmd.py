...
def generate(
    ...
    from kctl_cf.cli import app as cli_app

    skill_name = "cloudflare-admin"
    description = "Cloudflare DNS/CDN/WAF administration via kctl-cf CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-cf skill generate")
            raise typer.Exit(1)
