...
from kctl_dokploy.core.exceptions import KctlError
...
def init(
    ...
    api_url = url or typer.prompt("Dokploy URL (e.g. https://dokploy.kodeme.io)")
...
def test(ctx: typer.Context) -> None:
    ...
    try:
        c.client.get("/project.all")
        out.success("Connected to Dokploy API")
