...
def generate(
    ...
    from kctl_telegram.cli import app as cli_app

    skill_name = "telegram-admin"
    description = "Telegram bot platform administration via kctl-telegram CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-telegram skill generate")
            raise typer.Exit(1)
