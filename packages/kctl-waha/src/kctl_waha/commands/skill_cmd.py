...
def generate(
    ...
    from kctl_waha.cli import app as cli_app

    skill_name = "waha-admin"
    description = "WAHA WhatsApp HTTP API administration via kctl-waha CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-waha skill generate")
            raise typer.Exit(1)
