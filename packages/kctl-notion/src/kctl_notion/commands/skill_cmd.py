...
def generate(
    ...
    from kctl_notion.cli import app as cli_app

    skill_name = "notion-admin"
    description = "Notion wiki management via kctl-notion CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-notion skill generate")
            raise typer.Exit(1)
