...
def generate(
    ...
    from kctl_mm.cli import app as cli_app

    skill_name = "mattermost-admin"
    description = "Mattermost team chat administration via kctl-mm CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-mm skill generate")
            raise typer.Exit(1)
