...
def generate(
    ...
    from kctl_hz.cli import app as cli_app

    skill_name = "hetzner-admin"
    description = "Hetzner Cloud infrastructure administration via kctl-hz CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-hz skill generate")
            raise typer.Exit(1)
