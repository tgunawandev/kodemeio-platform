...
def generate(
    ...
    from kctl_pg.cli import app as cli_app

    skill_name = "postgres-admin"
    description = "PostgreSQL server administration via kctl-pg CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-pg skill generate")
            raise typer.Exit(1)
