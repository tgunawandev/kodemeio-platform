...
def generate(
    ...
    from kctl_gatus.cli import app as cli_app

    skill_name = "gatus-admin"
    description = "Gatus health monitoring administration via kctl-gatus CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-gatus skill generate")
            raise typer.Exit(1)
