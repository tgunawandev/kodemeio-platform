...
def generate(
    ...
    from kctl_rustdesk.cli import app as cli_app

    skill_name = "rustdesk-admin"
    description = "RustDesk remote desktop administration via kctl-rustdesk CLI"
    ...
    if check:
        ...
        if is_stale:
            ...
            out.info("Run: kctl-rustdesk skill generate")
            raise typer.Exit(1)
